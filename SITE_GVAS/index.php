...
<body class="index">
    ...
    <div class="burger-menu ">
        <ul class="links">
            ...
            <div class="buttons-burger-menu">
                ...
                <a href="admin.php" class="action-button pro"><i class="fas fa-user-shield"></i> Admin</a>
            </div>
        </ul>
    </div>
    ...
    <header>
        ...
        <div class="navbar">
            ...
            <div class="buttons">
                <a href="admin.php" class="action-button pro">
    ...
    <div class="fab-container">
        ...
        <div class="fab-actions">
            ...
            <a href="test/index.php" target="_blank" class="fab-item">
                <span class="fab-label">Administrateur</span>
                <div class="fab-btn">
